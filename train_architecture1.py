...
#%%
# Class ConvLSTM (https://github.com/ndrplz/ConvLSTM_pytorch)
...
##########
# (TO MODIFY)
model_path = r'C:\resnet18_ConvLSTM_1.pt'
...
#model
model = CameraTrapMultiLabels( nbr_cl = len(dico), pretrained = True, batch_size = 1, kernel_size = (3,3), gpu = train_on_gpu)
print(model)
